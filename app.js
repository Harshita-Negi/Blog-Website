...
app.get('/posts/:postName' , function(req , res){
  ...
  posts.forEach(function(post){          // CHALLENGE 17
    const storedTitle =_.lowerCase(post.title);   // CHALLENGE 18
    if(requestedTitle===storedTitle){
      res.render("post", { title : post.title, content : post.body } )  // CHALLENGE 19
    }
  
  })


 // console.log(req.params.postName);       // CHALLENGE 16
})
